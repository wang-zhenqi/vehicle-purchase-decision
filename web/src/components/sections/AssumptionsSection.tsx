      ...
      <Card>
        ...
        <CardContent className="grid grid-cols-1 gap-4 sm:grid-cols-2">
          <div>
            ...
            <Input inputMode="numeric" value={a.baolaiAnnualFuelCny} onChange={(e) => setA({ baolaiAnnualFuelCny: Number(e.target.value) })} />
          </div>
          <div>
            <Label>年均保险（元/年）</Label>
            <Input inputMode="numeric" value={a.baolaiAnnualInsuranceCny} onChange={(e) => setA({ baolaiAnnualInsuranceCny: Number(e.target.value) })} />
          </div>
          <div>
            <Label>年均维保（元/年）</Label>
            <Input inputMode="numeric" value={a.baolaiAnnualMaintenanceCny} onChange={(e) => setA({ baolaiAnnualMaintenanceCny: Number(e.target.value) })} />
          </div>
          <div>
            <Label>若卖出：估计残值（元）</Label>
            <Input inputMode="numeric" value={a.baolaiResidualIfSoldCny} onChange={(e) => setA({ baolaiResidualIfSoldCny: Number(e.target.value) })} />
          </div>
          <div className="sm:col-span-2">
            <Label>大修风险准备金（元/年）</Label>
            <Input inputMode="numeric" value={a.baolaiRepairReserveCnyPerYear} onChange={(e) => setA({ baolaiRepairReserveCnyPerYear: Number(e.target.value) })} />
      ...
      <Card>
        ...
        <CardContent className="grid grid-cols-1 gap-4 sm:grid-cols-2">
          <div>
            ...
            <Input inputMode="decimal" value={a.opportunityCostAnnualRatePct} onChange={(e) => setA({ opportunityCostAnnualRatePct: Number(e.target.value) })} />
          </div>
          <div>
          ...
          <div>
            ...
            <Input inputMode="numeric" value={a.monthlyPaymentLimitCny} onChange={(e) => setA({ monthlyPaymentLimitCny: Number(e.target.value) })} />
          </div>
        </CardContent>
      </Card>
